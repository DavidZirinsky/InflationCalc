...
class FREDInflationCalculator:
    ...
    def calculate_value(self, amount, start_date, end_date, reverse = False):
...
if __name__ == "__main__":
    ...
    # Example output: $1000 in 2020-01-01 would be worth $1195.60 in 2024-01-01
    ...
    # Example output: To have $1000 in 2024-01-01, you would have needed $836.45 in 2020-01-01
    reverse = calculator.calculate_value(1000, "2020-01-01", "2024-01-01", True)
    print(f"${reverse['original_amount']} in {reverse['start_date']} would be worth ${reverse['adjusted_amount']} in {reverse['end_date']}")
