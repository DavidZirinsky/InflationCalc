...
# from botocore.vendored import requests # importing requests causes issues in a lambda
...
#     return response(200, {"message": API_KEY})
...
#         if start_date_str and end_date_str and amount:
#             # Parse dates
